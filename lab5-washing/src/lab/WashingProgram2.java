...
class WashingProgram2 extends MessagingThread<WashingMessage> {
    ...
    private final int waterVolume = 10, waterTemperature = 60;
    ...
    public void run() {
        try {
            ...
            temp.send(new WashingMessage(this, WashingMessage.TEMP_SET, 40)); // regulate the temperature

            spin.send(new WashingMessage(this, WashingMessage.SPIN_SLOW)); //start spinning

            Thread.sleep(15 * 60000 / Wash.SPEEDUP); //wait for 30 minuter
